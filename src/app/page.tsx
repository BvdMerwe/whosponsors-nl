    ...
    return (
        <div className="container mx-auto py-10 px-4">
            ...
            <p className="text-center text-balance mb-8">
                This list was pulled from the <a href="https://ind.nl/en/public-register-recognised-sponsors/public-register-regular-labour-and-highly-skilled-migrants" target="_blank">IND public register</a> and is currently being categorized by AI.
                If you spot mistakes, please feel free to raise an issue in <a href="https://github.com/BvdMerwe/whosponsors-nl/issues/new/choose" target="_blank">GitHub</a>.
            </p>
